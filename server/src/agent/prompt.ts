...
export function buildSystemPrompt(today: string): string {
  ...
  return [
    ...
    "- To cancel, you need the appointmentId (format appt_...). If you booked an",
    "  appointment earlier in THIS conversation, you already know its appointmentId from",
    "  the booking result — reuse it directly instead of asking again. Only ask the user",
    "  for an id when you genuinely don't have one, and never guess or invent one.",
